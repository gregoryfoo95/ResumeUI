...
export default function InfoBar(): JSX.Element {
    return (
        ...
        <div className="stat">
          ...
          <div className="stat-value text-2xl">Gregory Foo</div>
          <div className="stat-desc">Corgi Lover</div>
        </div>
        ...
        <div className="stat">
          ...
          <div className="stat-value text-2xl">Software Engineer</div>
          <div className="stat-desc text-base">@RAiD</div>
        </div>
